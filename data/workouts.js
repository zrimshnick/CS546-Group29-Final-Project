...
import { checkString, checkArray, checkNumber, checkID, checkDate, checkTime } from '../helpers.js'
...
export const createWorkout = async (
    ...
    //Error checking
    if (userID === undefined || date === undefined || timeElapsed === undefined || workoutType === undefined ||
