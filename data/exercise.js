...
export const createExercise = async (
    ...
    if (workoutType.toLowerCase() != 'weight training' && workoutType.toLowerCase() != 'calisthenics' &&
        workoutType.toLowerCase() != 'cardio') {
        throw `workoutType must be either weight training, calisthenics, or cardio`;
    }
    ...
    if (workoutType.toLowerCase() === "weight training" || workoutType.toLowerCase() === "calisthenics") {
        ...
        if (weightUnits.toLowerCase() !== "lbs" && weightUnits.toLowerCase() !== "kgs") {
        ...
        if (distanceUnits.toLowerCase() !== "mi" && distanceUnits.toLowerCase() !== "km") {
...
export const updateExercise = async (exerciseId, updateObject) => {
    ...
    if (updateObject.weightUnits) {
        ...
        if (updateObject.weightUnits.toLowerCase() !== "lbs" && updateObject.weightUnits.toLowerCase() !== "kgs") {
            throw `weightUnits must be in lbs or kgs`;
        }
    ...
    if (updateObject.distanceUnits) {
        ...
        if (updateObject.distanceUnits.toLowerCase() !== "mi" && updateObject.distanceUnits.toLowerCase() !== "km") {
            throw `distanceUnits must be in mi or km`;
        }
